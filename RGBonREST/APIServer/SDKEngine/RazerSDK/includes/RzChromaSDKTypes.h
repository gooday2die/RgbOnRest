...
namespace ChromaSDK
{
    ...
    namespace Keyboard
    {
        ...
        typedef enum RZKEY
        {
            ...
            RZKEY_OEM_1 = 0x0101,               /*!< ~ (tilde/ÚâÊÇ/îïÊÇ) (VK_OEM_3) */
            ...
            RZKEY_JPN_3 = 0x0504,               /*!< Ùí?üµ (VK_OEM_PA1) */
            RZKEY_JPN_4 = 0x0509,               /*!< ?üµ (0xFF) */
            RZKEY_JPN_5 = 0x050A,               /*!< ªÒªéª¬ªÊ/«««¿«««Ê (0xFF) */
